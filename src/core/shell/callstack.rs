...
use crate::core::{ExecutionParameters, callstack, env, error, functions, trace_categories};

impl<SE: crate::core::extensions::ShellExtensions> crate::core::Shell<SE> {
    ...
    pub(crate) fn enter_trap_handler(
        &mut self,
        signal: crate::core::traps::TrapSignal,
        handler: Option<&crate::core::traps::TrapHandler>,
    ) {
    ...
    pub fn current_shell_args(&self) -> &[String] {
        for frame in self.call_stack.iter() {
            match frame.frame_type {
                ...
                crate::core::callstack::FrameType::Function(..) => return &frame.args,
    ...
    pub fn current_shell_args_mut(&mut self) -> &mut Vec<String> {
        for frame in self.call_stack.iter_mut() {
            match frame.frame_type {
                // Function calls always shadow positional parameters.
                crate::core::callstack::FrameType::Function(..) => return &mut frame.args,
                // Executed scripts always shadow positional parameters.
