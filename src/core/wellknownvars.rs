...
use crate::core::{Shell, ShellValue, ShellVariable, error, extensions, sys, variables};
    ...
    if stack.iter_function_calls().next().is_none() {
        ...
        stack
            ...
            .filter_map(|frame| match &frame.frame_type {
                crate::core::callstack::FrameType::Function(func) => {
                    Some(func.function_name.as_str())
                }
                crate::core::callstack::FrameType::Script(script) => {
                    // Only include sourced scripts, not run scripts
                    if matches!(
                        script.call_type,
                        crate::core::callstack::ScriptCallType::Source
                    ) {
                        Some("source")
                    } else {
                        None
                ...
                crate::core::callstack::FrameType::TrapHandler(_)
                | crate::core::callstack::FrameType::Eval
                | crate::core::callstack::FrameType::CommandString
                | crate::core::callstack::FrameType::InteractiveSession => None,
            })
            .collect::<Vec<_>>()
            .into()
    }
    ...
    if stack.iter_function_calls().next().is_none() {
        ...
        stack
            ...
            .filter_map(|(frame_idx, frame)| match &frame.frame_type {
                crate::core::callstack::FrameType::Function(..)
                | crate::core::callstack::FrameType::Script(..) => {
    ...
    if stack.iter_function_calls().next().is_none() {
        ...
        stack
            ...
            .filter_map(|frame| match &frame.frame_type {
                ...
                crate::core::callstack::FrameType::TrapHandler(_)
                | crate::core::callstack::FrameType::Eval => None,
                crate::core::callstack::FrameType::CommandString
                | crate::core::callstack::FrameType::InteractiveSession => None,
            })
            .collect::<Vec<_>>()
...
fn get_bash_argc_value(shell: &dyn ShellState) -> variables::ShellValue {
    ...
    stack
        ...
        .filter_map(|frame| match &frame.frame_type {
            ...
            | crate::core::callstack::FrameType::Script(..)
            | crate::core::callstack::FrameType::CommandString
            | crate::core::callstack::FrameType::InteractiveSession => {
...
fn get_bash_argv_value(shell: &dyn ShellState) -> variables::ShellValue {
    ...
    for frame in stack.iter() {
        let include = match &frame.frame_type {
            ...
            | crate::core::callstack::FrameType::Script(..)
            | crate::core::callstack::FrameType::CommandString
            | crate::core::callstack::FrameType::InteractiveSession => true,
            crate::core::callstack::FrameType::TrapHandler(_)
            | crate::core::callstack::FrameType::Eval => false,
        };
