...
impl<SE: crate::core::extensions::ShellExtensions> crate::core::Shell<SE> {
    pub(super) fn load_history(
        ...
        Ok(Some(crate::core::history::History::import(history_file)?))
    }
    ...
    pub fn add_to_history(&mut self, command: &str) -> Result<(), error::Error> {
        if let Some(history) = &mut self.history {
            ...
            // Add it to history.
            history.add(crate::core::history::Item {
                id: 0,
