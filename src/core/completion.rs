...
impl Spec {
    ...
    pub async fn get_completions(
        ...
        context: &Context<'_>,
    ) -> Result<Answer, crate::core::error::Error> {
        ...
        if let Some(word_list) = &self.word_list {
            ...
            let options = crate::core::expansion::ExpanderOptions {
                pathname_expand: false,
                ..Default::default()
            };
            let words = crate::core::expansion::full_expand_and_split_word_with_options(
