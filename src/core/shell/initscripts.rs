...
use crate::core::{Shell, error, extensions, interp};
...
impl<SE: extensions::ShellExtensions> Shell<SE> {
    ...
    pub async fn load_config(
        ...
        if self.options.login_shell {
            ...
            //     * ~/.profile
            //
            if let Some(system_profile) = crate::core::sys::fs::get_system_profile_path() {
            ...
            if self.options.interactive {
                match rc_behavior {
                    ...
                    RcLoadBehavior::LoadDefault => {
                        ...
                        //     ~/.bashrc
                        //
                        if let Some(system_rc) = crate::core::sys::fs::get_system_rc_path() {
