...
use crate::core::{Shell, ShellFd, extensions, results, sys};
...
pub enum ErrorKind {
    ...
    UnexpectedScopeType {
        ...
        expected: crate::core::env::EnvironmentScope,
        /// The actual scope type.
        actual: crate::core::env::EnvironmentScope,
    },
    ...
    EvalError(#[from] crate::core::arithmetic::EvalError),
    ...
    #[error("{1}: {0}")]
    ParseError(crate::core::parser::ParseError, crate::core::SourceInfo),

    /// An error occurred while parsing a function body.
    #[error("{0}: {1}")]
    FunctionParseError(String, crate::core::parser::ParseError),

    /// An error occurred while parsing a word.
    #[error(transparent)]
    WordParseError(#[from] crate::core::parser::WordParseError),

    /// Unable to parse a test command.
    #[error("invalid test command")]
    TestCommandParseError(#[from] crate::core::parser::TestCommandParseError),

    /// Unable to parse a key binding specification.
    #[error(transparent)]
    BindingParseError(#[from] crate::core::parser::BindingParseError),
