...
use crate::core::variables::{self, ShellValue, ShellValueUnsetType, ShellVariable};
...
pub(crate) struct ScopeGuard<'a, SE: extensions::ShellExtensions> {
    ...
    shell: &'a mut crate::core::Shell<SE>,
    detached: bool,
}
...
impl<'a, SE: extensions::ShellExtensions> ScopeGuard<'a, SE> {
    ...
    pub fn new(shell: &'a mut crate::core::Shell<SE>, scope_type: EnvironmentScope) -> Self {
    ...
    pub const fn shell(&mut self) -> &mut crate::core::Shell<SE> {
        self.shell
    }
