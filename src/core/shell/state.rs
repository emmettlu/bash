...
pub trait ShellState {
    ...
    fn traps(&self) -> &crate::core::traps::TrapHandlerConfig;

    /// Returns a mutable reference to the shell's trap handler configuration.
    fn traps_mut(&mut self) -> &mut crate::core::traps::TrapHandlerConfig;
    ...
    fn call_stack(&self) -> &crate::core::callstack::CallStack;

    /// Returns the shell's history, if it exists.
    fn history(&self) -> Option<&crate::core::history::History>;

    /// Returns a mutable reference to the shell's history, if it exists.
    fn history_mut(&mut self) -> Option<&mut crate::core::history::History>;
