...
use crate::core::{functions, traps};
use std::{
    borrow::Cow,
...
pub struct ScriptCall {
    ...
    pub source_info: crate::core::SourceInfo,
}
...
pub struct Frame {
    ...
    pub entry: Option<Arc<crate::core::SourcePosition>>,
    ...
    pub current: Option<Arc<crate::core::SourcePosition>>,
...
impl Frame {
    ...
    pub fn adjusted_source_info(&self) -> crate::core::SourceInfo {
    ...
    pub fn current_pos_as_source_info(&self) -> crate::core::SourceInfo {
        self.pos_as_source_info(self.current.as_ref())
    }

    fn pos_as_source_info(
        &self,
        pos: Option<&Arc<crate::core::SourcePosition>>,
    ) -> crate::core::SourceInfo {
        let mut new_start = if let Some(existing_start) = &self.source_info.start {
            if let Some(current) = pos {
                Some(Arc::new(crate::core::SourcePosition {
...
impl CallStack {
    ...
    pub fn current_pos_as_source_info(&self) -> crate::core::SourceInfo {
        let Some(frame) = self.frames.front() else {
            return crate::core::SourceInfo::default();
        };
    ...
    pub fn set_current_pos(&mut self, position: Option<Arc<crate::core::SourcePosition>>) {
    ...
    pub fn push_script(
        ...
        source_info: &crate::core::SourceInfo,
    ...
    pub fn push_trap_handler(
        ...
        let source_info =
            handler.map_or_else(crate::core::SourceInfo::default, |h| h.source_info.clone());
    ...
    pub fn push_eval(&mut self) {
        self.frames.push_front(Frame {
            ...
            args: vec![],
            source_info: crate::core::SourceInfo::from("eval"), // TODO(source-info): fill this out
            current_line_offset: 0,
            current: None, // TODO(source-info): fill this out
            entry: None,   // TODO(source-info): fill this out
        });
    ...
    pub fn push_command_string(&mut self) {
        self.frames.push_front(Frame {
            ...
            args: vec![],
            source_info: crate::core::SourceInfo::from("environment"),
            current_line_offset: 0,
            current: None, // TODO(source-info): fill this out
            entry: None,   // TODO(source-info): fill this out
        });
    ...
    pub fn push_interactive_session(&mut self) {
        self.frames.push_front(Frame {
            ...
            args: vec![],
            current_line_offset: 0,
            source_info: crate::core::SourceInfo::from("main"),
            current: None, // TODO(source-info): fill this out
            entry: None,   // TODO(source-info): fill this out
        });
    }
