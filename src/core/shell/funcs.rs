...
impl<SE: extensions::ShellExtensions> crate::core::Shell<SE> {
    ...
    pub fn define_func_from_str(
        ...
        let def = crate::parser::ast::FunctionDefinition {
            fname: name.clone().into(),
            body: func_body,
        };

        self.define_func(name, def, &crate::core::SourceInfo::default());
