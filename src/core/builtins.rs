...
use crate::core::{BuiltinError, CommandArg, commands, error, extensions, results};
...
///        crate::core::builtins::parse_known::<CommandLineArgs, _>(std::env::args());
///    if raw_args.is_some() {
